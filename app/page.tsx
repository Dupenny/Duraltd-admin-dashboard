...
const PRODUCTS = [
  {
    id: "durapayment",
    name: "DuraPayment",
    desc: "Payment gateway & merchant tools",
    icon: "💳",
    accent: "#2563EB",
    light: "#EFF6FF",
  },
  {
    id: "durapay",
    name: "DuraPay",
    desc: "Personal banking & transfers",
    icon: "🏦",
    accent: "#10B981",
    light: "#ECFDF5",
  },
...
export default function LoginPage() {
  ...
  const [pendingUser, setPending] = useState<
    (typeof DEMO_USERS)[string] | null
  >(null);
  ...
  async function submitOtp(e: React.FormEvent) {
    ...
    if (otp !== MOCK_OTP) {
      setErrors({ code: "Incorrect verification code. Demo OTP: 123456" });
      return;
    }
    setLoading(true);
  ...
  function pickProduct(id: string) {
    ...
    if (pendingUser) {
      ...
      localStorage.setItem(
        SESSION_KEY,
        JSON.stringify({ user: { ...userData }, product: prod }),
      );
    }
      ...
      <div
        ...
        <div
          style={{
            ...
            boxShadow: "0 8px 40px rgba(13,27,62,0.09)",
            overflow: "hidden",
            ...
            <div className="login-card-inner">
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <p style={{ color: "#8A97B0", fontSize: 14 }}>
                  Sign in to your Dura LTD admin account
                </p>
              </div>
              <form
              ...
              <div
                ...
                <p style={{ fontSize: 12, color: "#B0BAD0" }}>
          ...
          {step === "otp" && (
            <div className="login-card-inner">
              ...
              <p style={{ color: "#8A97B0", fontSize: 14, marginBottom: 4 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      borderColor: errors.code ? "#EF4444" : undefined,
                      height: 58,
                    }}
                  />
                  {errors.code && (
          ...
          {step === "product" && (
            <div style={{ padding: "40px" }}>
              <div
                ...
                <div
                  style={{
                    ...
                    height: 40,
                    borderRadius: 11,
                    background: pendingUser?.avatarColor ?? "#2563EB",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    color: "#fff",
                ...
                <div>
                  <p
                    style={{ fontWeight: 700, fontSize: 15, color: "#0D1B3E" }}>
                    Welcome back, {pendingUser?.name?.split(" ")[0]}!
                  </p>
                  <p style={{ fontSize: 12, color: "#8A97B0" }}>
                    {pendingUser?.title}
                  </p>
                </div>
              </div>
              ...
              <p style={{ color: "#8A97B0", fontSize: 13, marginBottom: 24 }}>
                ...
                {PRODUCTS.map((p) => (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      el.style.boxShadow = `0 4px 18px ${p.accent}20`;
                      el.style.transform = "translateY(-2px)";
                    }}
                    onMouseLeave={(e) => {
                      const el = e.currentTarget;
                      el.style.borderColor = "#E2E8F4";
        ...
        <p
          ...
          © 2025 Dura LTD · Internal use only · All rights reserved
        </p>
      </div>
